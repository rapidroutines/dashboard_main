...
const ChatbotPage = () => {
    ...
    return (
        <div className="flex flex-col gap-y-6">
            ...
            {/* Container with rounded corners that match the iframe */}
            <div className="w-full h-[700px] rounded-xl overflow-hidden bg-white dark:bg-slate-950 shadow-md">
                {/* Loading Indicator */}
                {isLoading && (
                ...
                {/* Chatbot Iframe - ensure style matches parent container */}
